...
define('my-app', class extends WeElement {
    ...
    window.addEventListener('message', event => {
      ...
      switch (message.cmd) {
        case 'vscodeCallback':
          ...
          (this.data.callbacks[message.cbid] || function () { })(message.data);
          delete this.data.callbacks[message.cbid];
          this.update()
          break;
        default: break;
      }
  ...
  onChangeA = () => {
    ...
    this.callVscode({cmd: 'setConfig', key: 'omi.open.welcome', value: this.data.show}, null)
  }
