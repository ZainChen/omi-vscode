...
const wc = require("./welcome/index");  //欢迎界面
...
const cp = require("./completion/index");  //自动补全功能模块
...
function activate(context) {
	const omiWelcome =  new wc.OmiWelcome(context);  //欢迎界面
	...
	const omiCompletion = new cp.OmiCompletion();  //自动补全功能
