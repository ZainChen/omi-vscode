...
## 版本 2.1.8 2019年06月15日

### 新增

- 添加 Omim 部分组件补全，支持用户新增自定义组件补全。
...
## 版本 2.1.5 2019年06月12日

### 新增

- 添加 Omi 自定义代码高亮注入 `[标签属性支持 json 高亮, omi css 高亮]`

### 修改

- 左侧菜单功能使用方式 `[修改中...]`
- 暂时关闭生态系统和 github
- 重做菜单图标(svg 格式，中间透明，而不是白色)。`[当前版本已解决]`
